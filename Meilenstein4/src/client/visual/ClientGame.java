...
public class ClientGame extends JFrame implements ActionListener {
	...
	public ClientGame(int size_x, int size_y) {
		this.size_x = size_x;
		this.size_y = size_y;
	...
	public void actionPerformed(ActionEvent e) {
		...
		int answer = JOptionPane.showConfirmDialog(null, "NAME hat dich herausgefordert für Snake! Annehmen?", "Herausforderung", JOptionPane.YES_NO_OPTION);
