...
public class FutternGUI extends JFrame implements ActionListener {
	...
	public FutternGUI(int size_x, int size_y, Client clientobj, String opponent) {
		this.size_x = size_x;
		this.size_y = size_y;
		this.clientobj=clientobj;
		setTitle("Futtern: "+clientobj.getUsername()+" vs. "+opponent);
